...
<head>
    ...
    <title>{{ config('app.name', 'stodio') }}</title>

    {{-- css links --}}

    <link rel="stylesheet" href="{{asset('/css/cart.music.css')}}">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                    <img src="{{asset('/storage/images/'.Auth::user()->image)}}" alt="" width="50px" style="border-radius: 100%">
                                </a>
